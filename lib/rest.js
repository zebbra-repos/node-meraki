 ...
 * const version = 'v0'
 * const target = 'n12'
 * const rest = require('./lib/rest')({ version, apiKey, target })
 */
function createRestAPI (settings) {
   ...
   */
  const adminEndpoints = require('./rest/admins')({ apiKey, target, basePath: `${basePath}/organizations` })
   ...
   */
  const templatesEndpoints = require('./rest/templates')({ apiKey, target, basePath: `${basePath}/organizations` })
   ...
   */
  const networksEndpoints = require('./rest/networks')({ apiKey, target, basePath })
   ...
   */
  const organizationEndpoints = require('./rest/organizations')({ apiKey, target, basePath: `${basePath}/organizations` })
