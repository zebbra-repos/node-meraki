 ...
 * const portEndpoints = require('./lib/rest/ports')({ apiKey, target, basePath, baseUrl, port })
 */
function createPortsEndpoints ({ apiKey = '', target = 'api', basePath = '/', baseUrl = 'https://api.meraki.com', port = 443 }) {
