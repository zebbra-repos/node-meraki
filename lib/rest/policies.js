 ...
 * const policyEndpoints = require('./lib/rest/policies')({ apiKey, target, basePath, baseUrl, port })
 */
function createPoliciesEndpoints ({ apiKey = '', target = 'api', basePath = '/', baseUrl = 'https://api.meraki.com', port = 443 }) {
