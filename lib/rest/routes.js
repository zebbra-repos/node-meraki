 ...
 * const routeEndpoints = require('./lib/rest/routes')({ apiKey, target, basePath, baseUrl, port })
 */
function createRoutesEndpoints ({ apiKey, target, basePath, baseUrl = 'https://api.meraki.com', port = 443 }) {
