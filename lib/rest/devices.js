 ...
 * const deviceEndpoints = require('./lib/rest/devices')({ apiKey, target, basePath, baseUrl, port })
 */
function createDevicesEndpoints ({ apiKey = '', target = 'api', basePath = '/', baseUrl = 'https://api.meraki.com', port = 443 }) {
