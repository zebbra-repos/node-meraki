 ...
 * const ssidEndpoints = require('./lib/rest/ssids')({ apiKey, target, basePath, baseUrl, port })
 */
function createSSIDsEndpoints ({ apiKey, target, basePath, baseUrl = 'https://api.meraki.com', port = 443 }) {
