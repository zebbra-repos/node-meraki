 ...
 * const templateEndpoints = require('./lib/rest/templates')({ apiKey, target, basePath, baseUrl, port })
 */
function createTemplatesEndpoints ({ apiKey, target, basePath, baseUrl = 'https://api.meraki.com', port = 443 }) {
