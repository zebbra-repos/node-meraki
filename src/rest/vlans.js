...
function createVlansEndpoints ({
  ...
  function showNetworkVLAN ({
    ...
    return axios._get(
      ...
      localTarget || target,
      scope,
      `${basePath}/${networkId}/vlans/${vlanId}`
    )
  }
